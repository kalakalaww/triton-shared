module {
  func.func @l2_norm_kernel_2(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    affine.store %6, %reinterpret_cast_1[0] : memref<1xf32, strided<[1], offset: ?>>
    return
  }
}

module {
  func.func @sum_kernel_2(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    %subview = memref.subview %reinterpret_cast[0] [%2] [1] : memref<2xf32, strided<[1]>> to memref<?xf32, strided<[1]>>
    %subview_0 = memref.subview %alloc[0] [%2] [1] : memref<2xf32> to memref<?xf32, strided<[1]>>
    memref.copy %subview, %subview_0 : memref<?xf32, strided<[1]>> to memref<?xf32, strided<[1]>>
    %4 = bufferization.to_tensor %alloc restrict writable : memref<2xf32> to tensor<2xf32>
    %5 = bufferization.alloc_tensor() : tensor<f32>
    %inserted = tensor.insert %cst into %5[] : tensor<f32>
    %reduced = linalg.reduce ins(%4 : tensor<2xf32>) outs(%inserted : tensor<f32>) dimensions = [0] 
      (%in: f32, %init: f32) {

...
module {
  func.func @any_kernel_1(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xi1> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32) {
    ...
    %subview_0 = memref.subview %alloc[0] [%11] [1] : memref<1024xf32> to memref<?xf32, strided<[1]>>

module {
  func.func @amax_kernel_1(%arg0: memref<*xf32> {tt.divisibility = 16 : i32}, %arg1: memref<*xf32> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.divisibility = 16 : i32}, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [%2], sizes: [4], strides: [1] : memref<*xf32> to memref<4xf32, strided<[1], offset: ?>>
    ...
    %subview = memref.subview %reinterpret_cast[0] [%7] [1] : memref<4xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1], offset: ?>>
    %subview_0 = memref.subview %alloc[0] [%7] [1] : memref<4xf32> to memref<?xf32, strided<[1]>>
    memref.copy %subview, %subview_0 : memref<?xf32, strided<[1], offset: ?>> to memref<?xf32, strided<[1]>>
    %9 = bufferization.to_tensor %alloc restrict writable : memref<4xf32> to tensor<4xf32>
    %10 = bufferization.alloc_tensor() : tensor<f32>
    %inserted = tensor.insert %cst into %10[] : tensor<f32>
    %reduced = linalg.reduce ins(%9 : tensor<4xf32>) outs(%inserted : tensor<f32>) dimensions = [0] 
      (%in: f32, %init: f32) {
        %12 = arith.maxnumf %in, %init : f32
        linalg.yield %12 : f32
      }
